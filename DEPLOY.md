...
1. Crea un repositorio nuevo en [GitHub](https://github.com/new) (p. ej. `hola-mundo` o `mi-hola-mundo`).
...
Carpeta del proyecto: `D:\Agentes_ia\salida_fabrica\proyectos\hola-mundo`
